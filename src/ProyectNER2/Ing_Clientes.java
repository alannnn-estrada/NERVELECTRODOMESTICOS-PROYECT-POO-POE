...
public class Ing_Clientes extends javax.swing.JFrame {
    ...
    public Ing_Clientes() {
        ...
        nm.setMinimum(15);
        t_edad.setModel(nm);*/
        //*this.estMinimunSize(new Dimension(Value,Value));
    ...
    void cargar(String valor){
        ...
        String sqsl = "SELECT * FROM clientes WHERE CONCAT (CveCliente,'', NomCliente,'', DireCliente,'',TelCliente,'',CorreoCliente,'',RFC) LIKE '%"+valor+"%'";
    ...
    public void validarCamposVacios(){
        if (t_nomCliente.getText().isEmpty()) {
            ClienteLB.setText("Campo Obligatorio*");
        }else{
            ClienteLB.setText("");
        }
     ...
     public void validarNumero(java.awt.event.KeyEvent evento){
         ...
         if (t_numeroTEL.getText().length()>=10) {
             evento.consume();
    ...
    private void initComponents() {
        ...
        setTitle("Crear Cuenta Clientes");
        ...
        t_nomCliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_nomClienteActionPerformed(evt);
            }
        });
        t_nomCliente.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                t_nomClienteKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                t_nomClienteKeyTyped(evt);
            }
        });
        ...
        jLabel1.setText("Ingreso Cliente NERV");
                    ...
                    .addGroup(JPanelLayout.createSequentialGroup()
                        .addGroup(JPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(JPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(t_nomCliente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(t_direccion, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(JPanelLayout.createSequentialGroup()
                                .addGap(1, 1, 1)
                                .addGroup(JPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(t_RFC, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(t_correo, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(27, 27, 27)
                        .addGroup(JPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(CorreoLB, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ClienteLB, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(DireLB, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(NumLB, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(RFCLB, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        JPanelLayout.setVerticalGroup(
            ...
            .addGroup(JPanelLayout.createSequentialGroup()
                ...
                .addGroup(JPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(t_nomCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(t_numeroTEL.getText().length()==10 && t_RFC.getText().length()==12){
            ...
            String NombreTienda, Direccion, NumeroTEl, Correo, RFC;
            NombreTienda = t_nomCliente.getText();
            ...
            String sql="";
            sql= "INSERT INTO clientes (CveCliente,NomCliente,DireCliente,TelCliente,CorreoCliente,RFC) VALUES (NULL,?,?,?,?,?)";
            try {
    ...
    private void t_numeroTELActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        String placa = t_numeroTEL.getText();
    ...
    private void t_nomClienteActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
        t_nomCliente.transferFocus();
    }                                            
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if (fila>=0) {
            try {
                PreparedStatement psd = cn.prepareStatement("DELETE FROM clientes WHERE CveCliente='"+valor+"'");
                psd.executeUpdate();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if (fila>=0){
            ...
            t_nomCliente.setText(tb_datosCliTiendas.getValueAt(fila, 1).toString());
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        try {
            PreparedStatement psd = cn.prepareStatement("UPDATE `clientes` SET `NomCliente`='"+NombreTienda+"',`DireCliente`='"+Direccion+"',`TelCliente`='"+NumeroTEl+"',`CorreoCliente`='"+Correo+"',`RFC`='"+RFC+"' WHERE `CveCliente`='"+ID+"'");
            psd.executeUpdate();
    ...
    private void t_numeroTELKeyPressed(java.awt.event.KeyEvent evt) {                                       
        // TODO add your handling code here:
    ...
    private void t_nomClienteKeyReleased(java.awt.event.KeyEvent evt) {                                         
        // TODO add your handling code here:
        habilitarBoton();
        validarCamposVacios();
    }                                        

    private void t_nomClienteKeyTyped(java.awt.event.KeyEvent evt) {                                      
        // TODO add your handling code here:
